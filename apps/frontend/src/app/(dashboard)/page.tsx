                      ...
                      if (reservation) {
                        ...
                        return (
                          <div key={court._id} className="p-1 border-r border-b border-white/5 min-h-[65px] last:border-r-0">
                            {isStartSlot ? (
                              <div className="h-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-2.5 flex flex-col justify-between hover:border-primary/45 hover:bg-white/[0.08] transition-all duration-300 shadow-[0_4px_12px_rgba(0,0,0,0.15)] hover:shadow-[0_8px_20px_rgba(57,255,20,0.08)] group/res relative overflow-hidden">
          ...
          <div className="space-y-3 relative z-10">
            {clubReservations.length === 0 ? (
              ...
              clubReservations.map((reservation) => (
                <div
                  key={reservation._id}
                  className="relative group overflow-hidden flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between p-5 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-primary/30 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(57,255,20,0.03)] hover:scale-[1.01]"
                >
                  <div className="absolute -inset-px bg-gradient-to-r from-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" />
