  ...
  return (
    <>
      ...
      <nav className="flex-1 py-6 px-4 space-y-2.5 overflow-y-auto z-10">
        ...
        >
          <LayoutDashboard className={`w-5 h-5 mr-3 transition-colors ${isActive("/") ? "text-primary" : "text-zinc-400 group-hover:text-white"}`} />
          Panel general
        </Link>
        <Link
          href="/courts"
        ...
        >
          <CalendarDays className={`w-5 h-5 mr-3 transition-colors ${isActive("/courts") ? "text-primary" : "text-zinc-400 group-hover:text-white"}`} />
          Canchas
        </Link>
        <Link
          href="/analytics"
      ...
      <div className="p-4 border-t border-white/5 bg-white/[0.01] space-y-2.5 z-10">
        ...
        <button
          ...
          className="w-full flex items-center px-4 py-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 border-l-2 border-transparent hover:border-red-500 rounded-xl font-bold transition-all duration-300 text-left hover:translate-x-1"
        >
